 ...
 * the target image initializes by grayScaled operation featured by Runigram.java
 * For example, to morph the Thor into black and white version in 50 steps, use:
